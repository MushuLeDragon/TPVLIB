...
public class VlibApplication implements Serializable {
    ...
    private String link = "https://maps.googleapis.com/maps/api/js?key=AIzaSyD4KxzXrajl0VYXhys0DQB7giKZQGALRRs&sensor=TRUE&callback=initMap";
    ...
    void init() {
        ...
        System.out.println(getMycarto().getMarkers().getMarker().get(0).getFullAddress());
    }
